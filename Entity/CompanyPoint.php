...
//    private ?Group $group = null;
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata): void
    {
        ...
        $builder->setTable('company_points')
            ->setCustomRepositoryClass(CompanyPointRepository::class)
        ...
        $builder->createOneToMany('log', CompanyPointLog::class)
            ->mappedBy('point')
            ->cascadePersist()
            ->cascadeRemove()
            ->fetchExtraLazy()
...
//            ->build();
     ...
     * @return self
     */
    public function addLog(CompanyPointLog $log)
    {
        $this->log[] = $log;
    ...
    public function removeLog(CompanyPointLog $log): void
    {
